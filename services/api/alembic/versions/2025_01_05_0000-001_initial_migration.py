...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("LOW", "MEDIUM", "HIGH", "CRITICAL", name="goalpriority"),
            nullable=False,
    ...
    op.create_index(
        op.f("ix_health_records_tenant_id"),
        "health_records",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_health_records_user_id"), "health_records", ["user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_health_providers_user_id"),
        "health_providers",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "transaction_type",
            sa.Enum(
                "INCOME", "EXPENSE", "TRANSFER", "INVESTMENT", name="transactiontype"
            ),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["account_id"], ["financial_accounts.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        op.f("ix_investments_user_id"), "investments", ["user_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "salary_expectation_min", sa.Numeric(precision=12, scale=2), nullable=True
        ),
        sa.Column(
            "salary_expectation_max", sa.Numeric(precision=12, scale=2), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
    ...
    op.create_index(
        op.f("ix_job_experiences_profile_id"),
        "job_experiences",
        ["profile_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_education_records_user_id"),
        "education_records",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "does_not_expire", sa.Boolean(), nullable=True, server_default="false"
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
