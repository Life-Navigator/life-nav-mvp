...
def upgrade() -> None:
    ...
    op.create_table('agents',
        ...
        sa.Column('max_concurrent_tasks', sa.Integer(), nullable=True, server_default='5'),
        ...
        sa.Column('current_state', sa.Enum('IDLE', 'PROCESSING', 'COMPLETED', 'ERROR', 'SHUTDOWN', name='agentstate'), nullable=True, server_default='IDLE'),
        sa.Column('is_active', sa.Boolean(), nullable=True, server_default='true'),
        sa.Column('model_name', sa.String(length=100), nullable=True, server_default='maverick'),
    ...
    op.create_table('agent_tasks',
        ...
        sa.Column('status', sa.Enum('PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED', name='taskstatus'), nullable=False, server_default='PENDING'),
