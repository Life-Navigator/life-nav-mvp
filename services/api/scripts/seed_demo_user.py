...
async def main():
    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            print("\nData Summary:")
            print("  • Health: Providers, records, medications")
            print("  • Finance: 5 accounts, transactions, investments")
            print("  • Career: Profile with 3 job experiences, 14 skills")
            print("  • Education: 1 degree, 3 courses, 2 certifications")
            print("  • Goals: 5 goals with milestones")
            print("\nAreas left incomplete for demo:")
            print("  • Some health records can be uploaded (lab reports, X-rays)")
            print("  • Bank statements can be connected via Plaid")
            print("  • Investment documents can be uploaded")
            print("  • Resume can be updated")
            print("  • Additional certifications can be added")
            print("="*80 + "\n")
