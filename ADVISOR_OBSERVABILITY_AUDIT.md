...
| **Recommendation logs**    | ⚠️ The `recommendations.recommendations` rows ARE the durable record (source_module, evidence, assumptions, confidence, rank_score, created/updated). But there's no log of _why a rec was surfaced in a given turn_ or which recs the advisor referenced.                                                                                                                                                                                        |
