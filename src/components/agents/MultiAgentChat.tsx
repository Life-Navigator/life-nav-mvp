          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex gap-3">
                {Object.entries(sessionQuality).slice(0, 3).map(([key, value]) => (
                        ...
                        <div className="mt-4 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className={`
                              ...
                              ${message.recommendation.priority === 'critical' ? 'bg-red-100 text-red-700' :
                                message.recommendation.priority === 'high' ? 'bg-orange-100 text-orange-700' :
                                'bg-green-100 text-green-700'}
                            `}>
                              {message.recommendation.priority}
                            </span>
                          </div>
                          <p className="text-sm text-gray-700 mb-1">{message.recommendation.action}</p>
                          <p className="text-xs text-gray-600 italic">{message.recommendation.rationale}</p>
                        </div>
                      )}
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {engine?.getRoadmap()?.immediateActions.slice(0, 3).map((action) => (
              ...
              <div>
                ...
                <div className="space-y-1">
                  {engine?.getRoadmap()?.successMetrics.slice(0, 5).map((metric) => (
