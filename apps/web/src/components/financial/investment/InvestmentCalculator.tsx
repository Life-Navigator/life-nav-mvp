...
const InvestmentCalculator: React.FC = () => {
  ...
  const saveCurrentCalculation = () => {
    ...
    try {
      ...
      const savedCalculations = savedCalculationsStr ? JSON.parse(savedCalculationsStr) : [];
  ...
  const getAnnualProjectionData = () => {
    ...
    if (
      !activeResults ||
      !('annual_projection' in activeResults) ||
      !activeResults.annual_projection
    )
      return [];
  ...
  const getMonteCarloData = () => {
    const activeResults = getActiveResults();
    if (!activeResults || !('monte_carlo' in activeResults) || !activeResults.monte_carlo)
      return null;
    if (!('annual_projection' in activeResults) || !activeResults.annual_projection) return null;
  ...
  const getAllocationData = () => {
    const activeResults = getActiveResults();
    if (!activeResults || !('allocation' in activeResults) || !activeResults.allocation) return [];
  ...
  const getLumpSumVsDcaData = () => {
    ...
    const lumpSumResults = activeResults as any;
    const lumpSum = lumpSumResults.lump_sum?.annual_projection || [];
    const dca = lumpSumResults.dollar_cost_averaging?.annual_projection || [];
    const partial = lumpSumResults.partial_lump_sum_dca?.annual_projection || [];
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="w-full mb-6">
          ...
          <TabsTrigger value="lump_sum" className="flex-1">
            Lump Sum vs. DCA
          </TabsTrigger>
        </TabsList>
          ...
          <Tabs value={activeInnerTab} onValueChange={setActiveInnerTab} className="w-full">
            <TabsList className="w-full mb-4">
              ...
              <TabsTrigger
                value="results"
                className="flex-1"
                disabled={!results?.investment_growth}
              >
                Results
              </TabsTrigger>
              <TabsTrigger
                value="comparison"
                className="flex-1"
                disabled={!results?.scenario_comparison}
              >
                Comparison
              </TabsTrigger>
            </TabsList>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvestmentChange('initial_investment', Number(e.target.value))
                      }
                      min={0}
                      step={1000}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvestmentChange('time_horizon_years', Number(e.target.value))
                      }
                      min={1}
                      max={50}
                      step={1}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvestmentChange('annual_return_rate', Number(e.target.value))
                      }
                      min={0}
                      max={20}
                      step={0.1}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvestmentChange('inflation_rate', Number(e.target.value))
                      }
                      min={0}
                      max={10}
                      step={0.1}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvestmentChange('fee_percentage', Number(e.target.value))
                      }
                      min={0}
                      max={3}
                      step={0.05}
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvestmentChange('contribution_amount', Number(e.target.value))
                      }
                      min={0}
                      step={100}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInvestmentChange('contribution_frequency', value)
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvestmentChange('contribution_growth_rate', Number(e.target.value))
                      }
                      min={0}
                      max={10}
                      step={0.5}
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2 flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        handleInvestmentChange('include_monte_carlo', e.target.checked)
                      }
                      className="mr-2 h-4 w-4"
                    />
                    <label htmlFor="monte-carlo" className="font-medium">
                  ...
                  <div className="space-y-2 flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        handleInvestmentChange('include_monthly_detail', e.target.checked)
                      }
                      className="mr-2 h-4 w-4"
                    />
                    <label htmlFor="monthly-detail" className="font-medium">
                  ...
                  {formData.include_monte_carlo && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInvestmentChange('simulation_runs', Number(e.target.value))
                        }
                        min={100}
                        max={10000}
                        step={100}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                        <div>
                          ...
                          <p className="text-2xl font-bold">
                            {formatCurrency(results.investment_growth.summary.final_balance)}
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-2xl font-bold">
                            {formatCurrency(
                              results.investment_growth.summary.inflation_adjusted_benefit
                            )}
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-2xl font-bold">
                            {formatPercent(
                              results.investment_growth.summary.compound_annual_growth_rate
                            )}
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                          <div className="text-center p-4 bg-muted rounded-lg">
                            ...
                            <div className="text-2xl font-bold">
                              {formatCurrency(
                                results.investment_growth.monte_carlo.median_final_balance
                              )}
                            </div>
                          </div>
                          ...
                          <div className="text-center p-4 bg-muted rounded-lg">
                            ...
                            <div className="text-2xl font-bold">
                              {formatCurrency(results.investment_growth.monte_carlo.worst_case)} /{' '}
                              {formatCurrency(results.investment_growth.monte_carlo.best_case)}
                            </div>
                          </div>
                        </div>
                            ...
                            <div className="space-y-2">
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {formatCurrency(
                                    results.investment_growth.scenario.initial_investment
                                  )}
                                </span>
                              </div>
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {formatCurrency(
                                    results.investment_growth.summary.total_contributions
                                  )}
                                </span>
                              </div>
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium text-green-600">
                                  {formatCurrency(
                                    results.investment_growth.summary.investment_growth
                                  )}
                                </span>
                              </div>
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium text-red-600">
                                  {formatCurrency(results.investment_growth.summary.total_fees)}
                                </span>
                              </div>
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {results.investment_growth.summary.growth_multiple.toFixed(2)}x
                                </span>
                              </div>
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {formatPercent(
                                    results.investment_growth.summary.real_return_rate
                                  )}
                                </span>
                              </div>
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {formatCurrency(
                                    results.investment_growth.summary.inflation_adjusted_balance
                                  )}
                                </span>
                              </div>
                              <div className="flex justify-between pt-2 border-t">
                                ...
                                <span className="font-bold">
                                  {results.investment_growth.scenario.time_horizon_years} years
                                </span>
                              </div>
                            </div>
                          </div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="overflow-x-auto">
                          <table className="min-w-full border divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                              {results.scenario_comparison.scenarios.map(
                                (scenario: any, i: number) => (
                                  <tr
                                    key={i}
                                    className={
                                      scenario.name ===
                                      results.scenario_comparison.best_performing
                                        .by_inflation_adjusted
                                        ? 'bg-green-50'
                                        : ''
                                    }
                                  >
                      ...
                      <Card className="bg-primary/10 mt-6">
                        ...
                        <CardContent>
                          <p className="mb-4">
                            Based on your investment goals, we recommend the following:
                          </p>
        ...
        <TabsContent value="allocation" className="space-y-4">
          <Tabs value={activeInnerTab} onValueChange={setActiveInnerTab} className="w-full">
            <TabsList className="w-full mb-4">
              ...
              <TabsTrigger value="results" className="flex-1" disabled={!results?.asset_allocation}>
                Results
              </TabsTrigger>
            </TabsList>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value={RiskLevel.MODERATELY_CONSERVATIVE}>
                          Moderately Conservative
                        </SelectItem>
                        <SelectItem value={RiskLevel.MODERATE}>Moderate</SelectItem>
                        <SelectItem value={RiskLevel.MODERATELY_AGGRESSIVE}>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleAllocationChange('time_horizon_years', Number(e.target.value))
                      }
                      min={1}
                      max={50}
                      step={1}
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-2 flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        handleAllocationChange('customize_allocation', e.target.checked)
                      }
                      className="mr-2 h-4 w-4"
                    />
                    <label htmlFor="customize-allocation" className="font-medium">
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        <label className="font-medium">
                          Stock Percentage ({allocationData.custom_stock_percentage}%)
                        </label>
                        <SliderInput
                          value={allocationData.custom_stock_percentage}
                          onChange={(value) =>
                            handleAllocationChange('custom_stock_percentage', value)
                          }
                          min={0}
                          max={100}
                          step={5}
                    ...
                    <CardContent className="pt-6">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                        <div>
                          ...
                          <p className="text-2xl font-bold">
                            {formatPercent(results.asset_allocation.portfolio.expected_return)}
                          </p>
                        </div>
                        <div>
                          <h3 className="text-sm font-medium opacity-80">Portfolio Volatility</h3>
                          <p className="text-2xl font-bold">
                            {formatPercent(results.asset_allocation.portfolio.volatility)}
                          </p>
                        </div>
                        <div>
                          <h3 className="text-sm font-medium opacity-80">Sharpe Ratio</h3>
                          <p className="text-2xl font-bold">
                            {results.asset_allocation.portfolio.sharpe_ratio.toFixed(2)}
                          </p>
                        </div>
                      </div>
                    </CardContent>
                    ...
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {Object.entries(results.asset_allocation.asset_class_metrics).map(
                            ([assetClass, metrics]: [string, any]) => (
                              <div key={assetClass} className="p-3 border rounded">
                                ...
                                <div className="text-sm text-muted-foreground space-y-1">
                                  ...
                                  <div className="flex justify-between">
                                    <span>Range:</span>
                                    <span>
                                      {formatPercent(metrics.worst_year)} to{' '}
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">
                                {results.asset_allocation.projected_growth.years} years
                              </span>
                            </div>
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">
                                {formatPercent(
                                  results.asset_allocation.projected_growth.percentage
                                )}
                              </span>
                            </div>
                            <div className="pt-2 border-t flex justify-between">
                              ...
                              <span className="font-bold capitalize">
                                {results.asset_allocation.portfolio.risk_level}
                              </span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-sm">
                            This allocation balances your risk tolerance with your time horizon to
                            provide an optimal mix of growth potential and downside protection.
                          </p>
                        </div>
                      </div>
                    </CardContent>
        ...
        <TabsContent value="lump_sum" className="space-y-4">
          <Tabs value={activeInnerTab} onValueChange={setActiveInnerTab} className="w-full">
            <TabsList className="w-full mb-4">
              ...
              <TabsTrigger value="results" className="flex-1" disabled={!results?.lump_sum_dca}>
                Results
              </TabsTrigger>
            </TabsList>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleLumpSumChange('time_horizon_years', Number(e.target.value))
                      }
                      min={1}
                      max={50}
                      step={1}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number"
                      value={
                        lumpSumData.expected_return_rate === null
                          ? ''
                          : lumpSumData.expected_return_rate
                      }
                      onChange={(e) =>
                        handleLumpSumChange(
                    ...
                    <CardContent className="pt-6">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                        <div>
                          ...
                          <p className="text-2xl font-bold">
                            {results.lump_sum_dca.comparison.best_strategy}
                          </p>
                        </div>
                        <div>
                          <h3 className="text-sm font-medium opacity-80">Expected Annual Return</h3>
                          <p className="text-2xl font-bold">
                            {formatPercent(results.lump_sum_dca.expected_annual_return)}
                          </p>
                        </div>
                        <div>
                          <h3 className="text-sm font-medium opacity-80">Total Amount</h3>
                          <p className="text-2xl font-bold">
                            {formatCurrency(results.lump_sum_dca.total_amount)}
                          </p>
                        </div>
                      </div>
                    </CardContent>
                        ...
                        <table className="min-w-full border divide-y divide-gray-200">
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            ...
                            >
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {formatCurrency(
                                  results.lump_sum_dca.dollar_cost_averaging.period_investment
                                )}{' '}
                                monthly for {results.lump_sum_dca.dca_periods} months
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {formatCurrency(
                                  results.lump_sum_dca.dollar_cost_averaging.final_balance
                                )}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {formatCurrency(
                                  results.lump_sum_dca.dollar_cost_averaging.growth_amount
                                )}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {formatPercent(
                                  results.lump_sum_dca.dollar_cost_averaging.growth_percentage
                                )}
                              </td>
                            </tr>
                            <tr
                            ...
                            >
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {formatCurrency(
                                  results.lump_sum_dca.partial_lump_sum_dca.initial_investment
                                )}{' '}
                                now +{' '}
                                {formatCurrency(
                                  results.lump_sum_dca.partial_lump_sum_dca.period_investment
                                )}{' '}
                                monthly
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {formatCurrency(
                                  results.lump_sum_dca.partial_lump_sum_dca.final_balance
                                )}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {formatCurrency(
                                  results.lump_sum_dca.partial_lump_sum_dca.growth_amount
                                )}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {formatPercent(
                                  results.lump_sum_dca.partial_lump_sum_dca.growth_percentage
                                )}
                              </td>
                            </tr>
                          </tbody>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <p className="text-sm">
                            Historically, lump sum investing outperforms DCA about 2/3 of the time
                            in rising markets, but DCA can reduce risk during market downturns.
                          </p>
                        </div>
                          ...
                          <div className="p-4 bg-primary/10 rounded-lg">
                            ...
                            <p className="text-sm text-muted-foreground">
                              ...
                              <span className="capitalize">
                                {results.lump_sum_dca.risk_considerations.risk_level}
                              </span>
                            </p>
                          </div>
                        </div>
