...
const RetirementCalculator: React.FC = () => {
  ...
  const { calculateRetirement, isLoading, results, calculateQuickRetirement } =
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="w-full mb-6">
          ...
          <TabsTrigger value="results" className="flex-1" disabled={!results}>
            Results
          </TabsTrigger>
        </TabsList>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleConfigChange('currentAnnualIncome', parseFloat(e.target.value))
                  }
                  min={0}
                  step={1000}
                />
              ...
              <div className="space-y-2">
                <SliderInput
                  name="desiredIncomeReplacementRate"
                  label="Desired Income Replacement (%)"
                  value={config.desiredIncomeReplacementRate}
                  onChange={(_name, value) =>
                    handleConfigChange('desiredIncomeReplacementRate', value)
                  }
                  min={30}
                  max={100}
                  step={5}
