...
interface WhatWhatWhyChatProps {
  userGoals: Goal[];
  benefitSelections: {
    domain: string;
...
export const WhatWhatWhyChat: React.FC<WhatWhatWhyChatProps> = ({
  userGoals,
  benefitSelections,
  userId,
  onComplete,
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-white shadow-sm border-b px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-slate-800">What-What-Why Discovery</h2>
