      ...
      <div className="space-y-6">
        ...
        <Card>
          <div className="p-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Choose a strong, unique password that you don't use for other websites or
              applications.
            </p>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mt-2 flex items-center">
              <div
                className={`h-4 w-4 rounded-full ${twoFactorEnabled ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'} mr-2`}
              ></div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                      Use these backup codes to sign in if you lose access to your authentication
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {backupCodes.map((code, index) => (
                        <div
                          key={index}
                          className="bg-gray-100 dark:bg-gray-700 p-2 rounded text-sm font-mono"
                        >
                          {code}
                        </div>
                      ))}
        ...
        <Card>
          <div className="p-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              These are the devices that are currently logged into your account. You can terminate
              any session that you don't recognize.
            </p>
        ...
        <Card>
          <div className="p-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Recent login attempts to your account. If you notice any suspicious activity, please
