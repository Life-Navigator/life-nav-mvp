        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Manage your healthcare preferences and privacy
            </p>
          </div>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                  <fieldset className="space-y-3" disabled={!settings.notificationsEnabled}>
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label
                        htmlFor="preventive-care-alerts"
                        className="ml-3 text-sm text-gray-700 dark:text-gray-300"
                      >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Allow your healthcare providers to access your health data through this
                      platform.
                    </p>
                  </div>
                  <div className="ml-4 flex-shrink-0">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Help improve healthcare by allowing anonymous usage of your health data for
                      research.
                    </p>
                  </div>
                  <div className="ml-4 flex-shrink-0">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-medium text-gray-900 dark:text-white">
                      Show Sensitive Medical Information
                    </h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Display sensitive information like diagnostic results and medications directly
                      in the dashboard.
                    </p>
                  </div>
                  <div className="ml-4 flex-shrink-0">
                  ...
                  <div className="grid grid-cols-2 gap-y-2">
                    {HEALTH_METRICS_OPTIONS.map((metric) => (
                      <div key={metric} className="flex items-center">
                        ...
                        />
                        <label
                          htmlFor={`metric-${metric.toLowerCase().replace(/\s+/g, '-')}`}
                          className="ml-3 text-sm text-gray-700 dark:text-gray-300"
                        >
                          {metric}
                        </label>
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <input
                              ...
                              name="name"
                              value={
                                settings.emergencyContacts.find((c) => c.id === editingContact)
                                  ?.name || ''
                              }
                          ...
                          <div className="flex items-center">
                            ...
                            />
                            <label
                              htmlFor={`access-records-${contact.id}`}
                              className="ml-3 text-xs text-gray-700 dark:text-gray-300"
                            >
