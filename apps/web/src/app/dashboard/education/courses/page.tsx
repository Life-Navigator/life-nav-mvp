  ...
  return (
    <div className="container mx-auto py-6 px-4 md:px-6">
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Course Integration is currently in development. Connect your learning platforms like
              Udemy, Coursera, and LinkedIn Learning to automatically track your educational
      ...
      {courses.length === 0 ? (
        ...
        <div>{/* Courses data will render here */}</div>
      )}
    </div>
  );
}
