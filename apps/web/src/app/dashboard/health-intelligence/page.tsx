...
// Health Intelligence (Sprint 19) — from uploaded health documents: lab markers vs general
// reference ranges (factual flag, never a diagnosis), supplements, medications, fitness,
// nutrition. Strict medical boundary — not medical advice.
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <p className="text-sm text-gray-500 mt-1">
        Your labs, supplements, medications, fitness & nutrition — organized from your documents.
      </p>

      <div className="mt-3 rounded-md border border-rose-200 bg-rose-50 px-4 py-3 text-xs text-rose-800">
