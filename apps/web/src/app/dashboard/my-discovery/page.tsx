        ...
        {d.domains.map((dm) => (
          ...
          >
            <div className="flex items-center justify-between">
              <h2 className="text-base font-bold text-gray-900">{dm.label} Discovery</h2>
              <span className="flex items-center gap-2 text-xs text-gray-500">
                <span className={`w-2 h-2 rounded-full ${STATUS[dm.status].color}`} />
                {STATUS[dm.status].label} · {dm.coverage_pct}%
              </span>
            </div>
            ...
            <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              ...
              <div>
                <div className="text-[11px] uppercase text-emerald-600 font-semibold">Unlocks</div>
