...
from .routers import career_domain, chat, decision, documents, education_domain, family_domain, finance, health, health_domain, analytics, life_profile, readiness, reports, share
